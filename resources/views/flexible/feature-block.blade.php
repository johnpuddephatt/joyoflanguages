    <div id="{{ $layout ? $layout->key() : null }}"
        ...
        <div
            ...
            <div class="{{ $layout->reverse ? 'lg:order-first lg:pr-12' : 'lg:pl-12' }} p-4 lg:px-8 2xl:py-8">
                <h2 class="type-lg max-w-lg">{!! $layout->title !!}</h2>
                @if ($layout->subtitle)
                    <div class="type-xs -mt-2 lg:max-w-xs">{{ $layout->subtitle }}
                    </div>
                @endif
            ...
            @if ($layout->show_thumb)
                <svg class="absolute right-4 top-full h-auto w-24 -translate-y-12 lg:left-1/2 lg:right-0 lg:w-32 lg:-translate-x-[90%]"
