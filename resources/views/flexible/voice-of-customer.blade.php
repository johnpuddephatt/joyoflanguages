         ...
         <div class="bg-yellow py-16 xl:py-24">
             ...
             <div x-data="{
                 ...
                 <div class="flex flex-col gap-24 xl:flex-row xl:items-center xl:gap-0">
                     ...
                     <div
                         class="relative z-10 grid max-w-xl grid-cols-2 grid-rows-2 gap-y-12 overflow-visible pb-8 md:gap-x-16 lg:gap-y-0 xl:w-2/5 xl:pb-0">
                         @foreach ($quotes as $row => $quoteRow)
                             ...
                             @foreach ($quoteRow->shuffle() as $key => $quote)
                                 <div x-show="currentRow == {{ $row }}"
                                     ...
                                     class="{{ ($key % 2) - ($row % 2) ? 'col-start-2' : 'col-start-1' }} row-start-{{ $key + 1 }} type-xs2 lg:type-sm relative col-span-1 flex h-24 items-center justify-center px-1 text-center sm:!leading-none lg:h-32 lg:px-4">
                                     {{ $quote->quote }}
