...
<dialog
    ...
    <form method="dialog">
        <button class="ml-auto block w-10 before:fixed before:inset-0 before:-z-10 before:bg-white before:bg-opacity-50"
...
@if ($layout->outro)
    <x-hint>
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="40.76" height="43.06"
            class="absolute right-0 top-0 h-auto w-16 -translate-y-1/3 lg:translate-x-1/3" viewBox="0 0 40.76 43.06">
            <path fill="#fff"
            ...
            <circle cx="21.68" cy="19.08" r="18.19" fill="none" stroke="#151616" stroke-linecap="round"
                stroke-linejoin="round" stroke-width="1.77" />
            <path fill="none" stroke="#151616" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.45"
