<div
    class="{{ $layout->background_colour }} @if (in_array($layout->background_colour, ['bg-teal'])) text-white @endif relative flex min-h-screen flex-col items-center justify-center gap-4 overflow-hidden pt-16 lg:h-screen lg:flex-row lg:pt-12">
