<div
    ...
    <div x-data="{ playing: {{ $layout->autoplay ? 'true' : 'false' }} }"
        ...
        <div class="relative lg:translate-y-32">
            <svg id="blobs" class="block h-auto w-[150%] max-w-none lg:max-h-[85vh] lg:w-full"
            ...
            <div class="absolute left-0 top-0">
                ...
                <svg class="relative block h-full w-[150%] max-w-none lg:max-h-[85vh] lg:w-full"
                    xmlns="http://www.w3.org/2000/svg" width="1172.89" height="1107.97" viewBox="0 0 1172.89 1107.97">
                    <defs>
                        <style>
                            .prefix__cls-70 {
                    ...
                    <path
                        d="M133.67 462.55S119.4 461.2 120 475.29s23.38 36 65.66 34.18c17.16-1.8 18.24-19.51 2.07-28.19"
                        class="prefix__cls-70" />
