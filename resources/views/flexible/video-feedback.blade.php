    ...
    <div class="{{ $class ?? 'mx-auto' }} container">
        <div
            ...
            <div x-data="{
                ...
                <h3 class="type-md text-teal relative z-10 mt-2 text-center font-bold">See it
                    in
                    action!</h3>
                ...
                <template x-for="level in levels">
                    <div x-show="currentLevel == level.name" class="mt-0 flex flex-row gap-3">
                        ...
                        <div class="relative mt-12 w-1/2">
                            <div
                                class="absolute -top-4 right-2 z-10 flex h-20 w-20 rotate-6 items-center justify-center rounded-full p-1 text-center text-sm font-bold !leading-none md:text-base lg:h-24 lg:w-24 lg:p-4 xl:-right-4 xl:-top-8">
