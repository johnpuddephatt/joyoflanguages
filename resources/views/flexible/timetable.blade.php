<div id="{{ $layout ? $layout->key() : null }}"
    ...
    <div class="{{ $class ?? 'mx-auto' }} container">
        <div
            class="{{ $layout->colour ?? 'bg-teal-light' }} {{ $layout->images ? ' pb-24 lg:pb-48' : null }} relative flex flex-col gap-2 rounded-3xl px-4 py-8 md:gap-4 lg:flex-row lg:p-16 2xl:gap-8">
                                                        ...
                                                        <template x-for="dayGroup in levelGroup.dayGroups"
                                                            ...
                                                            <template
                                                                ...
                                                                <div
                                                                    ...
                                                                    <template
                                                                        x-for="(session, index) in dayGroup.sessions"
