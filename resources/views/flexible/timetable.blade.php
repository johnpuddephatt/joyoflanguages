<div
    ...
    <div class="{{ $class ?? 'mx-auto' }} container">
        <div
            class="{{ $layout->colour ?? 'bg-teal-light' }} {{ $layout->images ? ' pb-24 lg:pb-48' : null }} {{ $layout->squiggle ? 'pt-16' : null }} relative flex flex-col gap-2 rounded-3xl px-4 py-8 md:gap-4 lg:flex-row lg:p-16 lg:py-8 2xl:gap-8">
