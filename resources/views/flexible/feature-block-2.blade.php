<div
    ...
    <div class="{{ $class ?? 'mx-auto' }} container">
        <div
            class="{{ $layout->colour ?? 'bg-teal-light' }} {{ $layout->images ? ' pb-16 md:pb-24 lg:pb-48' : null }} {{ $layout->squiggle ? 'pt-16' : null }} relative flex flex-col gap-2 rounded-3xl px-4 py-8 md:p-8 lg:flex-row lg:gap-4 lg:p-16 2xl:gap-8">
