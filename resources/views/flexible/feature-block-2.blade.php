<div
    ...
    <div class="{{ $class ?? 'mx-auto' }} container">
        <div
            ...
            @endif
            <img class="w-full lg:w-1/3" src="{{ Storage::url($layout->image) }}" />
        ...
        @if ($layout->images)
            <div
                ...
                @foreach ($layout->images as $key => $image)
                    <div
                        class="{{ match ($key) {0 => '-rotate-6 max-lg:mx-auto',1 => 'rotate-3 max-lg:ml-auto max-lg:-mt-[10em]',2 => '-rotate-3 max-lg:-mt-[20em]'} }} rotate relative w-1/2 flex-1 lg:w-auto">
