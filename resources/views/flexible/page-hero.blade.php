        ...
        <div class="relative w-full lg:w-1/2 lg:pl-8">
            ...
            @if ($layout->show_squiggles)
                <svg x-bind:class="{ 'opacity-0': trailerOpen }"
                    class="pointer-events-none absolute -bottom-4 -top-2 left-0 right-0 z-50 block h-auto w-full max-w-none transition duration-1000 lg:-left-6 lg:-right-4 lg:w-[111%] xl:-left-12"
