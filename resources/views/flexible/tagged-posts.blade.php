  <div id="{{ $layout ? $layout->key() : null }}" class="overflow-hidden">
      <div class="container-lg mx-auto flex flex-col items-start py-8 lg:flex-row lg:gap-8 lg:py-16">
          <div x-data="{ canPlay: false, playing: false }" class="relative flex-1 lg:mb-16 lg:w-1/2">
              <div class="relative -mx-16 mb-8 w-[calc(100%+8rem)] md:mx-0 md:w-full">

                  <svg xmlns="http://www.w3.org/2000/svg" width="1360.37" height="1301.42" class="h-auto w-full"
                  ...
                  <div class="absolute left-0 top-0 -mx-16 h-full w-[calc(100%+8rem)] md:mx-0 md:w-full">
                      <x-responsive-image
                          class="absolute left-[32%] top-[6.25%] h-[82.5%] w-[32%] object-cover object-center md:left-[30.5%] md:w-[36%]"
                          :image="$layout->image" />
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" width="1360.37" height="1301.42"
                      class="absolute left-0 top-0 h-full w-full" viewBox="0 0 1360.37 1301.42">
                      <style>
                          .cls-67 {
                              fill: #fff;
                              stroke: #12171e;
