<div class="relative -z-10 flex h-screen flex-col items-center justify-end overflow-hidden bg-black text-white">
    <div
        class="pointer-events-none absolute left-0 right-0 top-0 z-10 h-64 bg-gradient-to-b from-[#000000aa] to-transparent">
    </div>
    <x-library-image conversion="3x2" id="hero-image" class="fixed inset-0 h-full w-full object-cover" :image="$page->image" />
